...
#### Creating my figure
```{r, fig.cap= "This figure shows the nutrient levels for rivers in Brisley, Puerto Rico"}
ggplot(conc_mean, aes(sample_date, roll_mean)) +
  ...
  theme_minimal() +
  theme(strip.background = element_blank(), strip.placement = "outside", strip.text.y = element_text(size = 5), legend.position = "top", axis.text.y = element_text(size = 5))
```
